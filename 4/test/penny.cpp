...
string colorFile = "penny-image.jpg";
string depthFile = "penny-depth.jpg";

void read_images() {
  im_color color_image;
  im_float depth_image;
  color_image.ReadJpg(colorFile.c_str());
  depth_image.ReadJpg(depthFile.c_str());
